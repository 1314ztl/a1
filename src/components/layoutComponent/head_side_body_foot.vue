    <template>
        <div class="app-container">
          <div style="visibility: hidden;"><slot  style="visibility: hidden;"></slot></div>
          <Example2></Example2>
          <component :is="nodep">

          </component>
        <!-- 头部区域 -->
        <header  ref="sl1" v-if="groupedSlots.header.length" class="app-header">
            <component 
  ...
  <script setup >
    ...
    import { computed, h, ref, render, useSlots } from 'vue';
    import example from "../basicComponent/example.vue"
    import Example2 from '../basicComponent/example2.vue';
    const slots = useSlots();
    const sl1=ref('');
    const nodep = h(example);
